...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "mkdir -p /home/geloman/.ssh /home/geloman/.config /home/geloman/.personal /home/geloman/.development /home/geloman/.language-servers/bin",
      ...
      "curl -L https://github.com/LuaLS/lua-language-server/releases/download/3.10.6/lua-language-server-3.10.6-linux-x64.tar.gz | tar /home/geloman/.language-servers/lua-language-server",
